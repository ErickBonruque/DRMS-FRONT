...
class LangmuirHinshelwoodPage extends StatefulWidget {
  const LangmuirHinshelwoodPage({Key? key}) : super(key: key);

  @override
  State<LangmuirHinshelwoodPage> createState() => _LangmuirHinshelwoodPageState();
}

class _LangmuirHinshelwoodPageState extends State<LangmuirHinshelwoodPage> {
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildMathDomainInput('K_{CO_2}', kCo2Min, kCo2Max),
                  ],
                ),
              ),
            ),
