...
class InletFlowsPage extends StatefulWidget {
  const InletFlowsPage({super.key});

  @override
  State<InletFlowsPage> createState() => _InletFlowsPageState();
}

class _InletFlowsPageState extends State<InletFlowsPage> {
